    ...
    >
        {#each files as file, index}
            <button
                ...
                class="relative aspect-square rounded-lg overflow-hidden bg-[var(--color-bg)] hover:ring-2 hover:ring-[var(--color-accent)] transition-all"
            >
                {#if isImage(file)}
                    <img
                ...
                {:else}
                    ...
                    >
                        <svg
                            class="w-6 h-6 text-[var(--color-text-muted)] mb-1"
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                        >
                        ...
                        <span
                            class="text-[10px] text-[var(--color-text-muted)] truncate w-full text-center px-1"
                        >
